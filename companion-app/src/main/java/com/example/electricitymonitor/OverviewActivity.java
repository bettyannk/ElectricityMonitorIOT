...
import com.example.electricitymonitor.R;
import com.example.electricitymonitor.databinding.ActivityOverviewBinding;
...
public class OverviewActivity extends AppCompatActivity implements OverviewContract.View {
    ...
    protected void onStart() {
        ...
        binding.notifyPropertyChanged(com.example.electricitymonitor.BR.electricityModel);
    }
